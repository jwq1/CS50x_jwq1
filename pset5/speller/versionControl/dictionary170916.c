...
// TODO: initialize the hashtable[hash]s of all the nodes in the hashtable
// -----
...
bool check(const char *word)
{
    ...
    // // Store word
    // // char wordToCheck[] = malloc(strlen(word));
    // // if (wordToCheck == NULL) {
    // //     unload();
    // //     return false;
    // // }
    ...
    // // printf("%s", cursor->wordValue);

    // // // Skip over the hashtable[hash] node
    // // cursor = cursor->next;
    ...
    //         if ((strcasecmp(cursor->wordValue, word)) == 0)
    //         {
    ...
    //         else if ((strcasecmp(cursor->wordValue, word)) != 0 ) {
